...
//Actions
const FETCH = "KRO/MEETINGTYPES/FETCH";
...
export const fetchMeetingTypes = () => {
  return (dispatch, getState) => {
    ...
    new Api(getState().apiToken.value)
      ...
      .catch(error => {
        fetchMeetingTypesHandleError(dispatch, error);
      });
  };
};

//Helper Functions
const fetchMeetingTypesHandleError = (dispatch, error) => {
  console.log(error);
