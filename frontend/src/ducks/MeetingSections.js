...
//Actions
const FETCH = "KRO/MEETINGSECTIONS/FETCH";
...
export const fetchMeetingSections = () => {
  return (dispatch, getState) => {
    ...
    new Api(getState().apiToken.value)
      ...
      .catch(error => {
        fetchMeetingSectionsHandleError(dispatch, error);
      });
  };
};

//Helper Functions
const fetchMeetingSectionsHandleError = (dispatch, error) => {
  console.log(error);
