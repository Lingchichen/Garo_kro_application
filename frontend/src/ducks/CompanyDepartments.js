...
//Actions
const FETCH = 'KRO/COMPANYDEPARTMENTS/FETCH';
...
export const fetchCompanyDepartments = token => dispatch => {
  dispatch({ type: FETCH });
  new Api(token)
    ...
    .catch(error => {
      fetchCompanyDepartmentsHandleError(dispatch, error);
    });
};

//Helper Functions
const fetchCompanyDepartmentsHandleError = (dispatch, error) => {
  console.log(error);
