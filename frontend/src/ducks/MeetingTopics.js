...
//Actions
const FETCH = "KRO/MEETINGTOPICS/FETCH";
...
export const fetchMeetingTopics = () => {
  return (dispatch, getState) => {
    ...
    new Api(getState().apiToken.value)
      ...
      .catch(error => {
        fetchMeetingTopicsHandleError(dispatch, error);
      });
  };
};

//Helper Functions
const fetchMeetingTopicsHandleError = (dispatch, error) => {
  console.log(error);
