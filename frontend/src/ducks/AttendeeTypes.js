...
//Actions
const FETCH = "KRO/ATTENDEETYPES/FETCH";
...
export const fetchAttendeeTypes = () => {
  return (dispatch, getState) => {
    ...
    new Api(getState().apiToken.value)
      ...
      .catch(error => {
        fetchAttendeeTypesHandleError(dispatch, error);
      });
  };
};

//Helper Functions
const fetchAttendeeTypesHandleError = (dispatch, error) => {
  console.log(error);
